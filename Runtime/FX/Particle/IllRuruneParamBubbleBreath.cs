...
namespace jp.illusive_isc.RuruneOptimizer
{
    ...
    internal class IllRuruneParamBubbleBreath : IllRuruneParam
    {
        ...
        private static readonly List<string> MenuParameters = new() { "Particle3" };

        public IllRuruneParamBubbleBreath Initialize(
            VRCAvatarDescriptor descriptor,
            AnimatorController animator
        )
        {
        ...
        public IllRuruneParamBubbleBreath DeleteParam()
        {
        ...
        public IllRuruneParamBubbleBreath DeleteFxBT()
        {
        ...
        public IllRuruneParamBubbleBreath DeleteVRCExpressions(
        ...
        )
        {
            ...
            foreach (var control in menu.controls)
            {
                if (control.name == "Particle")
                {
                    ...
                    {
                        if (control2.name == "bubble breath")
                        {
